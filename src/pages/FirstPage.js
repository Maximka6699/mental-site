    ...
    <main className="main">
      <section className="intro">
        ...
        <div className="wrapper">
          <h1 className="title">&lt;whoiswear&gt;</h1>
          <p1 className="subtitle">одежда, как смысл жизни</p1>
        </div>
        {/* <!-- заголовок и подзаголовок --> */}
        ...
        <div className="wrapper">
          ...
          <div className="wrapper_grid2v">
            ...
            <div className="big_rect">
              ...
              <div className="link_cont_center">
                <a href="/delivery" className="smooth-underline">
                  перейти в раздел
                </a>
              </div>
            </div>
